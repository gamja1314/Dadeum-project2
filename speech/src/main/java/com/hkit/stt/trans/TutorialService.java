...
import com.hkit.stt.audio.AudioFile;
import com.hkit.stt.audio.AudioFileRepository;
...
public class TutorialService {
    ...
    try {
        ...
        String fileName = "audio_" + timestamp + "." + fileExtension;
            ...
            savedFile = new File(audioSavePath + File.separator + fileName); // 파일 저장 경로 설정
            ...
            double fileDurationSeconds = getFileDuration(savedFile);
    ...
    public void checkExternal(Member member, STTResult sttResult) {
		...
		//AudioFile External 표시
	    AudioFile audioFile = audioFileRepository.findBySttResult(sttResult);
	    if (audioFile != null) {
	        audioFile.setExternal(true);
	        audioFileRepository.save(audioFile);
	    }
	}
